    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">GiftPool</span>
            </div>
            <p className="text-gray-400 mb-4">
              Regalos grupales hechos simples.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link to="/crear-wishlist" className="hover:text-white transition">Crear Wishlist</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="#" className="hover:text-white transition">Carreras</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>© 2025 GiftPool. Hecho con ❤️ en Colombia.</p>
        </div>
      </div>
    </footer>
  )
